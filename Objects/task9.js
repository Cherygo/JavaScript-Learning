...
// on which is weighed and multiply the result (the mass) 
// for the gravitational force of the other planet. See the table below for a list of gravitational forces:
...
function spaceWeights(planetA, weight, planetB){
    return Math.round(weight / planets[planetA] * planets[planetB] * 100) / 100;
}
